...
export default function Ranking() {
  ...
  return (
    <div className="page">
      <h1>Ranking</h1>
      <p className="muted">Acerte palpites, ganhe pontos e suba na classificação.</p>
      ...
      <div className="table">
        ...
        )) : <div className="notice">O ranking está começando. Faça seus palpites e seja um dos primeiros a chegar ao topo.</div>}
      </div>
    </div>
  );
}
